...
public class Game extends Canvas implements Runnable
{
	...
	public void init()
	{
		...
		player = new Player(main_level, 225*8, main_level.height*8/2, input);				// Initialize the Player object with the level at the set coordinates interacting with the input handler.
